...
VLESS_XHTTP="vless://${UUID}@${SERVER}:${PORT}?type=xhttp&security=reality&sni=cdn.api.cloud.yandex.net&fp=chrome&pbk=${PUBLIC_KEY}&sid=${SHORT_ID}${USERNAME:+#${USERNAME}-xhttp}"
