...
На сервере прописаны все shortIds, на клиенте указывается один. Доступные:
`cbdc51eb`, `7ae88f24`, `f3116322`, `94571650`, `92e2b18e`, `a38c78ef`.
Сгенерировать новый: `openssl rand -hex 4`.
...
| Порт | 443 |
| UUID | скопировать из вывода add_user.sh |
| Flow | `xtls-rprx-vision` |
| Encryption | none |
| Security (Stream) | Reality |
| SNI | steamcommunity.com (или ваш dest) |
| Fingerprint | chrome |
| PublicKey | скопировать из вывода add_user.sh |
| ShortId | cbdc51eb (или любой из shortIds) |
